...
DES (Data Encryption Standard): 보안성 낮아 현재는 잘 안 씀
...
ECC (Elliptic Curve Cryptography): RSA보다 짧은 키로 같은 수준의 보안

DSA (Digital Signature Algorithm): 디지털 서명용
...
⚡ 속도	            매우 빠름	               빠름	                      느림
🔑 키 관리	        키 없음	              키 공유 필요	         공개키 공개, 개인키 보관
🔍 대표 용도	      비밀번호 저장,         파일 암호화,            인증 전자서명, 키 분배
                     무결성 검증	          통신 암호화
