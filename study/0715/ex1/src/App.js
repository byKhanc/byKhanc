...
function ProfileCard() {
  return (
    <div className="max-w-sm mx-auto mt-10 p-6 bg-white border rounded-lg shadow text-center">
      <img src="https://via.placeholder.com/100" className="rounded-full mx-auto mb-4" alt="프로필" />
...
// 3. 카드 그리드 (Card 컴포넌트 사용)
function CardGrid() {
  return (
    <div className="grid gap-4 p-4 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
      <Card icon="🌱" title="식물 가꾸기" description="매일 물을 주세요." />
      <Card icon="📅" title="캘린더" description="일정을 기록해요." />
      <Card icon="💬" title="커뮤니티" description="자유롭게 이야기 나눠요." />
    </div>
  );
}
